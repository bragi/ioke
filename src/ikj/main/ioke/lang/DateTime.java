...
public class DateTime extends IokeData {
    ...
    public void init(IokeObject obj) throws ControlFlow {
        ...
        obj.registerMethod(obj.runtime.newNativeMethod("parses provided text with DateTime in ISO format. Returns parsed date or nil if text does not contain a date", new TypeCheckingNativeMethod("fromIsoText") {
                private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
                    .builder()
                    .receiverMustMimic(runtime.dateTime)
